...
<div class="m-3 overflow-scroll border rounded-3 position-relative">
    ...
    >
        {#if showCopyCheckmark}
            <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="clipboard-check-icon m-2 darkreader-invert" style="color: var(--bs-success);">
                <path d="M13.78 4.22a.75.75 0 0 1 0 1.06l-7.25 7.25a.75.75 0 0 1-1.06 0L2.22 9.28a.751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018L6 10.94l6.72-6.72a.75.75 0 0 1 1.06 0Z"></path>
            </svg>
        {:else}
            <svg height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="clipboard-icon m-2 darkreader-invert">
